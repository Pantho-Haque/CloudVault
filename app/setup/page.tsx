    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-background)] px-4">
      <div className="bg-[var(--color-surface)] rounded-2xl shadow-xl p-8 max-w-md w-full border border-[var(--color-border)]">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[var(--color-text-primary)]">Welcome to CloudVault</h1>
          <p className="text-[var(--color-text-muted)] mt-1 text-sm">Create your admin account to get started</p>
        </div>
