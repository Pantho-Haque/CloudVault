                ...
                <td className="py-3 px-4 md:px-5" onClick={(e) => e.stopPropagation()}>
                  <div className={`flex items-center justify-end gap-1 md:gap-0.5 ${isHovered ? "opacity-100" : "md:opacity-0"} opacity-100 md:opacity-0 transition-opacity`}>
                    {!file.isDirectory && (
                      <>
                        <button
                          ...
                          className="p-2 rounded-lg text-[var(--color-icon-muted)] hover:text-[var(--color-primary)] hover:bg-[var(--color-primary-subtle)] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                          title="Download"
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg text-[var(--color-icon-muted)] hover:text-[var(--color-danger)] hover:bg-[var(--color-danger-subtle)] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
