              ...
              {!selectionMode && (
                <div className="flex justify-center gap-1.5 mt-3 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                  {!file.isDirectory && (
                    <>
                      <button
                        ...
                        className="p-2 bg-[var(--color-primary-subtle)] text-[var(--color-primary)] rounded-lg hover:opacity-80 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                        title="Download"
                      ...
                      <button
                        ...
                        className="p-2 bg-[var(--color-surface-raised)] text-[var(--color-icon-interactive)] rounded-lg hover:opacity-80 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                        title="Share"
                  ...
                  <button
                    ...
                    className="p-2 bg-[var(--color-danger-subtle)] text-[var(--color-danger)] rounded-lg hover:opacity-80 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                    title={file.isDirectory ? "Delete folder" : "Delete"}
                    aria-label={file.isDirectory ? `Delete folder ${file.name}` : `Delete ${file.name}`}
                  >
                    <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
